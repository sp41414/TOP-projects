...
export function loadSidebar(projectManager) {
  ...
  let deleteProjectContainer = document.createElement("div");
  deleteProjectContainer.id = "delete-project-container";
  deleteProjectContainer.appendChild(deleteProjectButton);
  createProjectTaskContainer.appendChild(deleteProjectContainer);
...
export function renderTasks(projectID) {
  ...
  const project = projectManagerGlobal
    .getProjects()
