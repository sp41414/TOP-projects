export default function initializeContent() {
  ...
  beverage1Description.textContent =
    "A warm, random flavor depending on the type. The randomness of the flavor, sweetness, saltness, makes it more fun!";
  ...
  main1Description.textContent =
    "The most dangerous insect reduced to a delicious and nutritious insect on your plate!";
  main2.innerHTML = "<p>Raw Fish</p>";
  main2Description.textContent = "Taste something better than Sushi!";
  main3.innerHTML = "<p>Raw Meat</p>";
  main3Description.textContent =
    "Go back to your carnivorous instincts and feast on this raw meat.";
  main4.innerHTML = "<p>Human</p>";
  main4Description.textContent =
    "What's better than eating your own kind? Eating your own kind!";
